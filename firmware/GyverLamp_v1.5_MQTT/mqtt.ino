...
int Get_EFFIDX (String effect) {
  ...
  if (effect.equals("Dемо")) return 27;
  ...
  if (effect.equals("Демо")) return 27;
...
String Get_EFFName (int eff_idx) {
  ...
  switch (eff_idx) {
    ...
    case 25: return "Инкрементная дрифт-роз";
    case 26: return "Демо";
  }
